...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() { "use strict";
        ...
        function e(e, t, r, o, i, s) {
            return r = (parseFloat(r) - parseFloat(e)) * i, o = (parseFloat(o) - parseFloat(t)) * s, Math.sqrt(r * r + o * o) }
        ...
        function r(e, t, r) {
            var o, i, s = e.indexOf(" ");
            return -1 === s ? (o = void 0 !== r ? r + "" : e, i = e) : (o = e.substr(0, s), i = e.substr(s + 1)), o = -1 !== o.indexOf("%") ? parseFloat(o) / 100 * t : parseFloat(o), i = -1 !== i.indexOf("%") ? parseFloat(i) / 100 * t : parseFloat(i), o > i ? [i, o] : [o, i] }
        ...
        function o(r) {
            ...
            var o, i, s, n, a, f, d, l = r.tagName.toLowerCase(),
                g = 1,
                u = 1; "non-scaling-stroke" === r.getAttribute("vector-effect") && (u = r.getScreenCTM(), g = u.a, u = u.d);
