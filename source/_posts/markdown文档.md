...
如果你在使用sublime text2或者sublime text3 并且已经安装了插件'MarkdownPreview'，用ctrl+shift+p 输入markdown选择markdown preview in brower来在浏览器中预览所编辑的文档

## Text basics
this is *italic* and this is **bold** .  another _italic_ and another __bold__
##这是一个标题
用‘#’加文字来标示一个标题，’#‘可以叠加 入“##”，数量越少字体越大例如html中的h1,h2
斜体：两个星号中间的是斜体 ，或则两个下划线  *斜体*  _xieti_
加粗：四个星号中间的是粗体，或者四个下划线中间 **粗体** __粗体__
